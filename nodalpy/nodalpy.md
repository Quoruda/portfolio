...
L'idée de ce projet m'est venue en utilisant Automatic1111, une interface pour la génération d'images/vidéos avec Stable Diffusion. NodalPy permet, grâce à des nœuds, de créer des workflows modulaires pour générer des images personnalisées. D'autres outils, comme Unreal Engine, proposent également des langages basés sur des nœuds.
...
* Le frontend en JavaScript (Vue), qui fournit une interface utilisateur interactive pour créer et gérer les nœuds.
